...
export class KubernetesService {
     ...
     */
    public static kubernetesReadKubernetesResources<ThrowOnError extends boolean = false>(options?: Options<KubernetesReadKubernetesResourcesData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<KubernetesReadKubernetesResourcesResponse, KubernetesReadKubernetesResourcesError, ThrowOnError>({
    ...
    /**
     * Read Kubernetes Stats
     * Get overall Kubernetes resources statistics.
     */
    public static kubernetesReadKubernetesStats<ThrowOnError extends boolean = false>(options?: Options<KubernetesReadKubernetesStatsData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<KubernetesReadKubernetesStatsResponse, unknown, ThrowOnError>({
     ...
     */
    public static kubernetesReadKubernetesResource<ThrowOnError extends boolean = false>(options: Options<KubernetesReadKubernetesResourceData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<KubernetesReadKubernetesResourceResponse, KubernetesReadKubernetesResourceError, ThrowOnError>({
    ...
    /**
     * Read Resource References
     * Get all references made by a specific resource.
     */
    public static kubernetesReadResourceReferences<ThrowOnError extends boolean = false>(options: Options<KubernetesReadResourceReferencesData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<KubernetesReadResourceReferencesResponse, KubernetesReadResourceReferencesError, ThrowOnError>({
     ...
     */
    public static kubernetesReadResourceHistory<ThrowOnError extends boolean = false>(options: Options<KubernetesReadResourceHistoryData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<unknown, KubernetesReadResourceHistoryError, ThrowOnError>({
     ...
     */
    public static kubernetesGetPopularHelmCharts<ThrowOnError extends boolean = false>(options?: Options<KubernetesGetPopularHelmChartsData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<unknown, KubernetesGetPopularHelmChartsError, ThrowOnError>({
    ...
    /**
     * Get Resource Adoption Trends
     * Get adoption trends for Kubernetes resource types
     */
    public static kubernetesGetResourceAdoptionTrends<ThrowOnError extends boolean = false>(options?: Options<KubernetesGetResourceAdoptionTrendsData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<unknown, KubernetesGetResourceAdoptionTrendsError, ThrowOnError>({
     ...
     */
    public static kubernetesGetHelmReleasesWithVersions<ThrowOnError extends boolean = false>(options?: Options<KubernetesGetHelmReleasesWithVersionsData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<unknown, KubernetesGetHelmReleasesWithVersionsError, ThrowOnError>({
