...
export class Repositories {
     ...
     */
    public static repositoriesDeleteRepository<ThrowOnError extends boolean = false>(options: Options<RepositoriesDeleteRepositoryData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).delete<RepositoriesDeleteRepositoryResponses, RepositoriesDeleteRepositoryErrors, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
